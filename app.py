...
# CSS INJECTION - Optimized for Safari & Responsive Viewports
st.markdown(f"""
    <style>
    /* 1. TYPOGRAPHY - Better Fallback and Loading */
    @font-face {{
    ...
    /* 2. UNIVERSAL RESET & LIGHT MODE FORCE */
    ...
    h1 {{ 
        ...
        letter-spacing: -1.2px; color: #1A1A1A; font-weight: 500 !important; 
    }}
    h3 {{ letter-spacing: -0.5px; color: #444; font-weight: 500 !important; }}

    /* Progressive Disclosures Styling */
    .subtitle {{
    ...
    /* 3. RESPONSIVE IMAGE BOX */
    [data-testid="stImage"] img {{
        max-width: 100% !important;
        height: auto !important;
        width: 240px !important;
        border-radius: 12px;
        mix-blend-mode: multiply; /* Blends PNG with white background */
    }}

    /* Metrics & Sliders */
    [data-testid="stMetricValue"] {{ 
        font-size: clamp(2rem, 8vw, 42px) !important; 
        letter-spacing: -0.8px; color: #1A1A1A; font-weight: 500 !important;
    }}
